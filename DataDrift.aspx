...
<asp:Label ID="LabelInfo" runat="server" ForeColor="Black" Font-Names="Arial" Font-Size="Small"></asp:Label><span class="analysisRecommendation">Highly recommended: review the complete results in <a class="NodeStyle" href="ComparisonReports.aspx">Comparison Reports</a> and <a class="NodeStyle" href="TimeSeries.aspx">Time Series</a>.</span><br /><br />
