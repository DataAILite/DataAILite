        ...
        <asp:UpdatePanel ID="udpCorrelationThreshold" runat="server">
          ...
          <Nodes>
            ...
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Filter correlations by threshold and show specialized views for stronger relationships between numeric fields."></asp:Label></div>
                            ...
                            <asp:Label ID="LabelInfo" runat="server" ForeColor="Black" Font-Names="Arial" Font-Size="Small"></asp:Label><span class="analysisRecommendation">Highly recommended: review the complete results in <a class="NodeStyle" href="Regression.aspx">Regression Analysis</a> and <a class="NodeStyle" href="ChartRecommendationHelpers.aspx">Chart Recommendations</a>.</span><br /><br />
