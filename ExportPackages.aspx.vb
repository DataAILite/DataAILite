...
Partial Class ExportPackages
    ...
    Private Sub WritePackageFiles(packageFolder As String)
        ...
        If IsIncluded("CSVData") AndAlso reportData IsNot Nothing Then
            File.WriteAllText(Path.Combine(packageFolder, "ReportData.csv"), ExportToCSVtext(reportData, ",", "", ""), Encoding.UTF8)
        End If

        If IsIncluded("ExcelData") AndAlso reportData IsNot Nothing Then
        ...
        If IsIncluded("ReportDefinition") Then
        ...
        WriteSelectedSnapshotFiles(packageFolder, manifest)
    End Sub
