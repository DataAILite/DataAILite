...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .tileGrid .analyticsTile:nth-child(18) {
            background-color: #fff9f5;
        }
        .tileGrid .analyticsTile:nth-child(19) {
            background-color: #f5f8ff;
        }
        .tileGrid .analyticsTile:nth-child(20) {
            background-color: #f8fff0;
        }
        .tileGrid .analyticsTile:nth-child(21) {
            background-color: #fff7ff;
        }
        .tileGrid .analyticsTile:nth-child(22) {
            background-color: #f4fffd;
        }
        .tileGrid .analyticsTile:nth-child(23) {
            background-color: #fffdf7;
        }
        .tileGrid .analyticsTile:nth-child(24) {
                                    ...
                                    <div class="tileGrid">
                                        ...
                                        <a id="tileCohort" runat="server" class="analyticsTile" href="Cohort.aspx" title="Open Cohort Analysis">
                                            <span class="tileCaption">
                                                ...
                                                <span class="tileText">First activity periods, later activity, retention, record counts, and value.</span>
                                            </span>
                                            <span class="tileBody">Track entities from first activity period into later periods to see retention and activity patterns.</span>
                                            <span class="previewBox"><asp:Literal ID="litPreviewCohort" runat="server"></asp:Literal></span>
                                            <span class="openText">Open</span>
                                        </a>

                                        <a id="tileFunnel" runat="server" class="analyticsTile" href="Funnel.aspx" title="Open Funnel Analysis">
                                            <span class="tileCaption">
                                                <span class="tileTitle">Funnel Analysis</span>
                                                <span class="tileText">Stage counts, drop-off, conversion percentage, and optional value by stage.</span>
                                            </span>
                                            <span class="tileBody">Review process steps or status values to see where records are gained, lost, or concentrated.</span>
                                            <span class="previewBox"><asp:Literal ID="litPreviewFunnel" runat="server"></asp:Literal></span>
                                            <span class="openText">Open</span>
                                        </a>

                                        <a id="tileABCPareto" runat="server" class="analyticsTile" href="ABCPareto.aspx" title="Open ABC Pareto Analysis">
                                            <span class="tileCaption">
                                                <span class="tileTitle">ABC Pareto Analysis</span>
                                                <span class="tileText">A/B/C classes by cumulative contribution to total value.</span>
                                            </span>
                                        ...
                                        <a id="tileKPIBuilder" runat="server" class="analyticsTile" href="KPIBuilder.aspx" title="Open KPI Builder">
                                            <span class="tileCaption">
                                                ...
                                                <span class="tileText">Calculated ratios, differences, sums, or products from numeric report fields.</span>
                                            </span>
