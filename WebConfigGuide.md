...
This guide walks you through configuring the `web.config` file for your DataAILite installation. The file is located in the root of your DataAI web application directory.
