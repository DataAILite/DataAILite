        ...
        <asp:UpdatePanel ID="udpRegression" runat="server">
          ...
          <Nodes>
            ...
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Analyze how one numeric column changes when another value changes, including linear, polynomial, exponential, power, and logistic probability options."></asp:Label>
                                ...
                                <br />
                                <asp:Label ID="LabelInfo" runat="server" ForeColor="Black" Font-Names="Arial" Font-Size="Small"></asp:Label><span class="analysisRecommendation">Highly recommended: review the complete results in <a class="NodeStyle" href="Trends.aspx">Trends</a> and <a class="NodeStyle" href="CorrelationThreshold.aspx">Correlation Threshold</a>.</span>
                                <br /><br />
