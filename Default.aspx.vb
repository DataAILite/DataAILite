...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim passl As String = ConfigurationManager.AppSettings("superpass").ToString.Trim
        Dim passw As String = Now.ToShortDateString
    ...
    Private Sub DeleteUser(indx As String)
        Dim constring As String = System.Configuration.ConfigurationManager.ConnectionStrings.Item("MySqlConnection").ToString
        Dim conprv As String = System.Configuration.ConfigurationManager.ConnectionStrings.Item("MySqlConnection").ProviderName.ToString
        ...
        End If
    End Sub
    Private Function DeleteTestUsers() As String
        Session("OURConnString") = System.Configuration.ConfigurationManager.ConnectionStrings.Item("mySQLconnection").ToString
        Session("OURConnProvider") = System.Configuration.ConfigurationManager.ConnectionStrings.Item("mySQLconnection").ProviderName.ToString
    ...
    Private Sub btLogin_Click(sender As Object, e As EventArgs) Handles btLogin.Click
        ...
        Dim ret As String = String.Empty
        Dim pass As String = ConfigurationManager.AppSettings("superpass").ToString.Trim
        Dim passw As String = Now.ToShortDateString
        Session("admin") = "user"
        ...
        Try
            ...
            If logon = pass AndAlso password = passw Then
                Session("admin") = "super"   'FOR the first INSTALL ONLY !!!!!!!!!!!!!!!!!!!!!!!!!
                Session("logon") = pass   'FOR the first INSTALL ONLY !!!!!!!!!!!!!!!!!!!!!!!!!
                Session("Application") = "InteractiveReporting"
            ...
            If (auth) Then   'authenticated
                ...
                ElseIf auto = "super" OrElse (logon = pass AndAlso password = passw) Then
