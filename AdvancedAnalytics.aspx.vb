...
Partial Class AdvancedAnalytics
    ...
    Private Sub DropDownListScenarios_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownListScenarios.SelectedIndexChanged
        ...
        If DropDownListScenarios.Text.Trim <> "" Then
            ...
            If scen = "4a" Then
                Response.Redirect("MultidimensionalBalancing.aspx?sel=4a")
            ElseIf scen = "4b" Then
                Response.Redirect("MultidimensionalBalancing.aspx?sel=4b")
            ElseIf scen = "4c" Then
                Response.Redirect("MultidimensionalBalancing.aspx?sel=4c")
            End If
            'tr4a.Visible = False
            'tr4b.Visible = False
            'Label35.Text = ""
