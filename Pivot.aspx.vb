...
Partial Class Pivot
    ...
    Private Sub FillAggregates()
        ...
        If LooksLikeIdentifierField(DropDownValueField.SelectedValue) Then
    ...
    Private Sub BindPivot(dt As DataTable)
        ...
        Else
            ...
            Session("Aggregate") = DropDownAggregate.SelectedValue
            HyperLinkMatrixPivotRecommendation.NavigateUrl = "ReportViews.aspx?graph=yes&cat1=" &
                Server.UrlEncode(DropDownRowField.SelectedValue) & "&cat2=" &
                Server.UrlEncode(DropDownColumnField.SelectedValue) & "&grtype=matrix&srd=11&y1=" &
                Server.UrlEncode(DropDownValueField.SelectedValue) & "&fn=" &
                Server.UrlEncode(DropDownAggregate.SelectedValue)
        End If
    End Sub
