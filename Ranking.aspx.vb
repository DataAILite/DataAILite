...
Partial Class Ranking
    ...
    Private Sub ApplyRequestSelections()
        SelectDropDownValue(DropDownRankField, Request("cat1"))
        SelectDropDownValue(DropDownValueField, Request("y1"))

        Dim groupField As String = ""
        If Request("cat2") IsNot Nothing Then groupField = Request("cat2").ToString().Trim()
        If groupField <> "" AndAlso Not String.Equals(groupField, DropDownRankField.SelectedValue, StringComparison.OrdinalIgnoreCase) Then
            SelectDropDownValue(DropDownGroupField, groupField)
        End If
    End Sub
